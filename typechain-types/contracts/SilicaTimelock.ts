...
export interface SilicaTimelockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CANCELLER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface SilicaTimelock extends BaseContract {
  connect(runner?: ContractRunner | null): SilicaTimelock;
  waitForDeployment(): Promise<this>;

  interface: SilicaTimelockInterface;
