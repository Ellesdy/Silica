...
export interface SilicaGovernorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface SilicaGovernor extends BaseContract {
  connect(runner?: ContractRunner | null): SilicaGovernor;
  waitForDeployment(): Promise<this>;

  interface: SilicaGovernorInterface;
